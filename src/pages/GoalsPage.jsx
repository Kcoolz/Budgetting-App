...
export default function GoalsPage({ goals, currency, onAdd, onAssign, onEdit, onDelete, onRemoveContribution, profileType = "personal" }) {
  ...
  return (
    <>
      ...
      <GoalsPanel goals={goals} currency={currency} onAdd={onAdd} onAssign={onAssign} onEdit={onEdit} onDelete={onDelete} onRemoveContribution={onRemoveContribution} profileType={profileType} />
    </>
  );
}
